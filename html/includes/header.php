...
<head>
    <base href="../../">
    <meta charset="utf-8">
    <meta name="author" content="Thomas Norbert NDALA">
            ...
            <div class="nk-sidebar nk-sidebar-fixed " data-content="sidebarMenu">
                <div class="nk-sidebar-element nk-sidebar-head">
                    <div class="nk-sidebar-brand">
                        <h3 class="text_dark">Checker_Rx</h3>
                    </div>
                                ...
                                <ul class="nk-menu">
                                    ...
                                    <li class="nk-menu-item">
                                        <a href="html/crypto/buy-sell.html" class="nk-menu-link">
                                            ...
                                            <span class="nk-menu-text">Bill in</span>
                                        </a>
                                    </li>
                                    <li class="nk-menu-item">
                                        <a href="html/crypto/wallets.html" class="nk-menu-link">
                                            <span class="nk-menu-icon"><em class="icon ni ni-wallet-alt"></em></span>
                                            <span class="nk-menu-text">Handpay</span>
                                        </a>
                                    </li>
                                    <li class="nk-menu-item">
                                        <a href="html/crypto/profile.html" class="nk-menu-link">
                                            <span class="nk-menu-icon"><em class="icon ni ni-sign-mxn"></em></span>
                                            <span class="nk-menu-text">Jackpots</span>
                                        </a>
                                    </li>
                                    <li class="nk-menu-item has-sub">
                                        <a href="#" class="nk-menu-link nk-menu-toggle">
                                            <span class="nk-menu-icon"><em class="icon ni ni-money"></em></em></span>

                                            <span class="nk-menu-text">Transfert de fonds</span>
                                        </a>
                                        <ul class="nk-menu-sub">
                                            <li class="nk-menu-item">
                                                <a href="html/crypto/welcome.html" class="nk-menu-link"><span class="nk-menu-text">Send funds</span></a>
                                            </li>
                                            <li class="nk-menu-item">
                                                <a href="html/crypto/kyc-application.html" class="nk-menu-link"><span class="nk-menu-text">Cashout</span></a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="nk-menu-item has-sub">
                                        ...
                                        <ul class="nk-menu-sub">
                                            <li class="nk-menu-item">
                                                <a href="html/crypto/welcome.html" class="nk-menu-link"><span class="nk-menu-text">Card in</span></a>
                                            </li>
                                            <li class="nk-menu-item">
                                                <a href="html/crypto/kyc-application.html" class="nk-menu-link"><span class="nk-menu-text">Card Out</span></a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="nk-menu-item">
                                        ...
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                            <div class="user-toggle">
                                                ...
                                                <div class="user-info d-none d-md-block">
                                                    <!-- <div class="user-status user-status-verified">Unverified</div> -->
                                                    <div class="user-name dropdown-indicator">Norbert NDALA</div>
                                                </div>
                                            </div>
                                        </a>
                                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right dropdown-menu-s1">
                                            <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                                                <div class="user-card">
                                                    ...
                                                    <div class="user-info">
                                                        <span class="lead-text">Norbert NDALA</span>
                                                        <span class="sub-text">ndalanorbert@gmail.com</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="dropdown-inner">
                                                <ul class="link-list">
                                                    <li><a href="html/crypto/profile.html"><em class="icon ni ni-user-alt"></em><span>Mon Compte</span></a></li>
                                            ...
                                            <div class="dropdown-inner">
                                                <ul class="link-list">
                                                    <li><a href="#"><em class="icon ni ni-signout"></em><span>Deconnexion</span></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </li>
                                                ...
                                                <div class="nk-notification">
                                                    <div class="nk-notification-item dropdown-inner">
                                                        ...
                                                        <div class="nk-notification-content">
                                                            <div class="nk-notification-text">Aucune notification</div>
